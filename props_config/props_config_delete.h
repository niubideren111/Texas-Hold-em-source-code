#ifndef __PROPS_CONFIG_DELETE_H__
#define __PROPS_CONFIG_DELETE_H__
class PropsConfigDeleteRequest
{
public:
	PropsConfigDeleteRequest(const string& json) {
...
class PropsConfigDeleteResponse
{
public:
	PropsConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
