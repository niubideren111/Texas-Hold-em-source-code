#ifndef __PROPS_CONFIG_INSERT_UPDATE_H__
#define __PROPS_CONFIG_INSERT_UPDATE_H__
class PropsConfigInsertUpdateRequest
{
public:
	PropsConfigInsertUpdateRequest(const string& json) {
...
class PropsConfigInsertUpdateResponse
{
public:
	PropsConfigInsertUpdateResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
